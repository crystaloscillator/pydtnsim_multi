...
# All rights reserved.
#
# $Id: null.py,v 1.3 2018/05/25 06:53:02 ohsaki Exp ohsaki $
#

COLOR_MAP = {
    'blue': 'nileblue', 'red': 'chocolate', 'magenta': 'orangewhite', 'cyan':
    'tealblue', 'green': 'mineralgreen', 'yellow': 'moonyellow'
}
