...
1.2
date	2018.10.15.12.53.08;	author ohsaki;	state Exp;
branches;
next	1.1;

1.1
date	2018.05.27.08.50.08;	author ohsaki;	state Exp;
branches;
next	;
...
# All rights reserved.
#
# $Id: fixed.py,v 1.1 2018/05/27 08:50:08 ohsaki Exp ohsaki $
#

import random

from dtnsim.mobility.fixed import Fixed as _Fixed
from perl import die
...
d7 1
a7 1
# $Id: Fixed.pm,v 1.15 2016/08/07 05:54:32 ohsaki Exp $
d13 1
a13 2
...
d21 1
a21 1
            die("Path class doesn't return a valid graph via graph().")
d27 1
a27 1
        self.move_to_point(self.random_point())
a28 1
...
d30 1
a32 1
    # return the Euclid distance between two vertices
d34 1
a36 1
    # return the edge legnth
d38 1
a40 1
...
a63 2
    # directly jump to the point defined by (edge, offset)
    def move_to_point(self, edge, offset):
a67 1
    # return the pair (edge, offset) of the vertex
d69 1
d76 1
a78 1
    # compute and store the current coordinate for later use
